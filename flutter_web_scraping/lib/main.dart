...
import 'package:flutter_web_scraping/kitap.dart';
...
class _HomeState extends State<Home> {
  ...
  Future getData() async {
    ...
    // resim=> element.children[2].children[0].children[0].children[0].attributes['src']
    //yayın evleri=>  element.children[4].text
                      ...
                      child: Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Kitap ismi:${kitaplar[index].kitapAdi}",
                                style: _style,
                              ),
                              Text(
